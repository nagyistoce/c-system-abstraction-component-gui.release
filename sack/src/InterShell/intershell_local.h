...
struct CanvasData {
	...
	struct {
		...
		_32 bEditMode : 1;
		_32 bIgnoreKeys : 1;
		//_32 bWaitForCaller : 1;
		_32 selected : 1;  // data in selection should be used for rendering
		_32 selecting : 1; // mouse has started selecting an area...
		_32 dragging : 1; // moving an existing control.
		_32 sizing : 1;
#define NO_SIZE_OP 0
#define UPPER_LEFT 1
...
#define DRAG_BEGIN 5
		_32 sizing_by_corner : 3; // 0 = upperleft, 1 = upperright, 2=lowerleft,, 3=lowerright
		_32 bSetResolution : 1; // set after npartsx, npartsy is set.
	} flags;
	struct {
		int _x, _y;
		int x, y, w, h;
...
void LoadInterShellPlugins( CTEXTSTR mypath, CTEXTSTR mask ); // used by intershell_common
