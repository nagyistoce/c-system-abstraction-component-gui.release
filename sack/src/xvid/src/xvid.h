...
#ifdef XVID_SOURCE
#define XVID_PROC(type,name) __declspec(dllexport) type CPROC name
#define XVID_DATA(type,name) __declspec(dllexport) type name
#else
#define XVID_PROC(type,name) __declspec(dllimport) type CPROC name
#define XVID_DATA(type,name) __declspec(dllimport) type name
#endif
#else
#ifdef XVID_SOURCE
#define XVID_PROC(type,name) type CPROC name
#define XVID_DATA(type,name) type name
#else
#define XVID_PROC(type,name) extern type CPROC name
#define XVID_DATA(type,name) extern type name
#endif
#endif
#endif
...
XVID_PROC( int, xvid_global )(void *handle, int opt, void *param1, void *param2);
...
XVID_PROC( int, xvid_decore )(void *handle, int opt, void *param1, void *param2);
...
XVID_PROC( int, xvid_encore )(void *handle, int opt, void *param1, void *param2);
