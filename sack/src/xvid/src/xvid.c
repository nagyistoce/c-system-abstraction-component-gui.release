 ...
 *
 * $Id: xvid.c,v 1.2 2004/07/26 19:07:35 jim Exp $
 *
 ****************************************************************************/
...
#ifdef _WIN32
	if ((cpu_flags & XVID_CPU_SSE) && sigill_check((void(*)(void))sse_os_trigger))
#else
...
#ifdef _WIN32
	if ((cpu_flags & XVID_CPU_SSE2) && sigill_check((void(*)(void))sse2_os_trigger))
#else
