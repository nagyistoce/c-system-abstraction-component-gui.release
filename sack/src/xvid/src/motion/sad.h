...
typedef uint32_t CPROC (sad16Func) (const uint8_t * const cur,
...
typedef uint32_t CPROC (sad8Func) (const uint8_t * const cur,
							const uint8_t * const ref,
							const uint32_t stride);
...
typedef uint32_t CPROC (sad16biFunc) (const uint8_t * const cur,
...
typedef uint32_t CPROC (sad8biFunc) (const uint8_t * const cur,
							   const uint8_t * const ref1,
							   const uint8_t * const ref2,
							   const uint32_t stride);
...
typedef uint32_t CPROC (dev16Func) (const uint8_t * const cur,
							 const uint32_t stride);
typedef dev16Func *dev16FuncPtr;
extern dev16FuncPtr dev16;
dev16Func dev16_c;

typedef uint32_t  CPROC (sad16vFunc)(	const uint8_t * const cur,
								const uint8_t * const ref,
...
typedef uint32_t CPROC (sse8Func_16bit)(const int16_t * cur,
								  const int16_t * ref,
								  const uint32_t stride);
