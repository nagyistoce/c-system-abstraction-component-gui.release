...
void CPROC MBPrediction(FRAMEINFO * frame,	/* <-- The parameter for ACDC and MV prediction */
...
void CPROC add_acdc(MACROBLOCK * pMB,
			uint32_t block,
...
void CPROC predict_acdc(MACROBLOCK * pMBs,
				uint32_t x,
				uint32_t y,
				uint32_t mb_width,
				uint32_t block,
