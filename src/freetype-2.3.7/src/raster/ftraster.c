...
#define FT_UNUSED_RASTER  FT_UNUSED( worker )
  ...
  typedef struct TWorker_2   TWorker, *PWorker;
...
#define SWAP_( x, y )  do                \
  ...
  /*  phase by the _generic Draw_Sweep() function.                          */
  /*                                                                       */
  /*************************************************************************/
  ...
  /*  sweep phase by the _generic Draw_Sweep() function.                  */
  /*                                                                     */
  /***********************************************************************/
