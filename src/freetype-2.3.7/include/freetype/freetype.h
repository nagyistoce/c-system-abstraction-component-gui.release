...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*                                                                       */
  /*    _generic             :: A field reserved for client uses.  See the  */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                                                                       */
  /*    _generic :: A typeless pointer, which is unused by the FreeType     */
  ...
  typedef struct  FT_SizeRec_
  {
    ...
    FT_Generic        _generic;   /* _generic pointer for client uses */
  ...
  /*                                                                       */
  /*    _generic           :: A typeless pointer which is unused by the     */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    A simple structure used to pass more or less _generic parameters    */
  /*    to @FT_Open_Face.                                                  */
  /*                                                                       */
  /* <Fields>                                                              */
