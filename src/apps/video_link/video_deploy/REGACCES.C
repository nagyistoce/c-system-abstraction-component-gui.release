...
int ProcessRegistryKeys(HKEY hKeyRoot, CTEXTSTR pClass, int (CPROC*f)(PTRSZVAL psv, CTEXTSTR key), PTRSZVAL psv )
{
   HKEY hKey;
    ...
    retCode = RegOpenKeyEx( hKeyRoot, pClass, 0, KEY_READ, &hKey );
