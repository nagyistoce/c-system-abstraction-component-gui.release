...
*/
SQLITE_PROC(int, sqlite3_close)(sqlite3 *);
...
SQLITE_PROC( void, sqlite3_free )(void*);
...
*/
SQLITE_PROC(int, sqlite3_open )(
  const char *filename,   /* Database filename (UTF-8) */
  sqlite3 **ppDb          /* OUT: SQLite db handle */
);
SQLITE_PROC(int, sqlite3_open16 )(
...
SQLITE_PROC( const char *,sqlite3_errmsg )(sqlite3*);
SQLITE_PROC( const void *,sqlite3_errmsg16 )(sqlite3*);
