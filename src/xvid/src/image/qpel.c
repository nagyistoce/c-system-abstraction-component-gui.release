...
#define FUNC_H      CPROC H_Pass_16_C
#define FUNC_V      CPROC V_Pass_16_C
#define FUNC_HA     CPROC H_Pass_Avrg_16_C
#define FUNC_VA     CPROC V_Pass_Avrg_16_C
#define FUNC_HA_UP  CPROC H_Pass_Avrg_Up_16_C
#define FUNC_VA_UP  CPROC V_Pass_Avrg_Up_16_C

#include __FILE__   /* self-include ourself */

/* note: B-frame always uses Rnd=0... */
#define STORE(d,s)  (d) = ( (s)+(d)+1 ) >> 1
#define FUNC_H      CPROC H_Pass_16_Add_C
#define FUNC_V      CPROC V_Pass_16_Add_C
#define FUNC_HA     CPROC H_Pass_Avrg_16_Add_C
#define FUNC_VA     CPROC V_Pass_Avrg_16_Add_C
#define FUNC_HA_UP  CPROC H_Pass_Avrg_Up_16_Add_C
#define FUNC_VA_UP  CPROC V_Pass_Avrg_Up_16_Add_C
...
#define STORE(d,s)  (d) = (s)
#define FUNC_H      CPROC H_Pass_8_C
#define FUNC_V      CPROC V_Pass_8_C
#define FUNC_HA     CPROC H_Pass_Avrg_8_C
#define FUNC_VA     CPROC V_Pass_Avrg_8_C
#define FUNC_HA_UP  CPROC H_Pass_Avrg_Up_8_C
#define FUNC_VA_UP  CPROC V_Pass_Avrg_Up_8_C

#include __FILE__   /* self-include ourself */

/* note: B-frame always uses Rnd=0... */
#define STORE(d,s)  (d) = ( (s)+(d)+1 ) >> 1
#define FUNC_H      CPROC H_Pass_8_Add_C
#define FUNC_V      CPROC V_Pass_8_Add_C
#define FUNC_HA     CPROC H_Pass_Avrg_8_Add_C
#define FUNC_VA     CPROC V_Pass_Avrg_8_Add_C
#define FUNC_HA_UP  CPROC H_Pass_Avrg_Up_8_Add_C
#define FUNC_VA_UP  CPROC V_Pass_Avrg_Up_8_Add_C
