...
typedef void CPROC (TRANSFER_8TO16COPY) (int16_t * const dst,
...
typedef void CPROC (TRANSFER_16TO8COPY) (uint8_t * const dst,
...
typedef void CPROC (TRANSFER_8TO16SUB) (int16_t * const dct,
								  uint8_t * const cur,
								  const uint8_t * ref,
...
typedef void CPROC (TRANSFER_8TO16SUBRO) (int16_t * const dct,
...
typedef void CPROC (TRANSFER_8TO16SUB2) (int16_t * const dct,
								   uint8_t * const cur,
								   const uint8_t * ref1,
								   const uint8_t * ref2,
								   const uint32_t stride);
...
typedef void CPROC (TRANSFER_16TO8ADD) (uint8_t * const dst,
								  const int16_t * const src,
								  uint32_t stride);
...
typedef void CPROC (TRANSFER8X8_COPY) (uint8_t * const dst,
								 const uint8_t * const src,
								 const uint32_t stride);
