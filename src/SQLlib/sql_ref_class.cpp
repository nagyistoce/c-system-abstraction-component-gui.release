	...
	namespace sql {
		...
		public:
			...
			SQL( String^ dsn )
			{
				...
				CTEXTSTR __dsn = sack::containers::text::WcharConvert( _dsn );
			...
			static array<String^>^ Query( String^ query )
			{
				...
				CTEXTSTR __query = sack::containers::text::WcharConvert( _query );
				int result_count;
				CTEXTSTR *results;
			...
			static bool Command( String^ command )
			{
				...
				CTEXTSTR __command = sack::containers::text::WcharConvert( _command );
