...
#ifndef BUTTON_KEY_STRUCTURE_DEFINED
...
KEYPAD_PROC( void, SetKeyTextField )( PKEY_BUTTON pKey, PTEXT_PLACEMENT pField, CTEXTSTR text );
...
KEYPAD_PROC( PTEXT_PLACEMENT, AddKeyLayout )( PKEY_BUTTON pKey, int x, int y, Font *font, CDATA color, _32 flags );
