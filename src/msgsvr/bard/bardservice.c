...
#define NUM_FUNCTIONS (sizeof(functions)/sizeof(server_function))
   ...
   // RegisterServiceHandler takes two parameters...the name of the new service, and a callback function to handle messages passed in.
	...
	{
		LoadFunction( WIDE("bag.msg.core.service"), NULL );
...
//#define UWM_LOAD_CARDSET       (WM_USER+302) //1326
//#define UWM_SET_GAME_PARAMS    (WM_USER+303) //1327
//#define UWM_JACKPOT_POSSIBLE   (WM_USER+304) //1328
//#define UWM_JACKPOT_IMPOSSIBLE (WM_USER+305) //1329
//#define UWM_BINGO_STATE_DATA   (WM_USER+306) //1330
//#define UWM_BINGO_STATE_FINAL  (WM_USER+307) //1331
//#define UWM_CARD_VERIFYING     (WM_USER+308) //1332
//#define UWM_JACKPOT_REVERIFY   (WM_USER+309)
