...
int GetRegistryBinary( char *pProduct, char *pValue,
                       char *pResult, int nMaxLen )
{
   return GetRegistryItem( HKEY_LOCAL_MACHINE, KEY_PREFIX,
                           pProduct, pValue,
...
int GetLocalRegistryBinary( char *pProduct, char *pValue,
                            char *pResult, int nMaxLen )
{
   return GetRegistryItem( HKEY_CURRENT_USER, KEY_PREFIX,
                           pProduct, pValue,
...
int SetRegistryBinary( char *pProduct, char *pKey, 
                       char *pValue, int nLen )
{
   return SetRegistryItem( HKEY_LOCAL_MACHINE, KEY_PREFIX,
                           pProduct, pKey, 
                           REG_BINARY,
...
int SetLocalRegistryBinary( char *pProduct, char *pKey, 
                            char *pValue, int nLen )
{
   return SetRegistryItem( HKEY_CURRENT_USER, KEY_PREFIX,
                           pProduct, pKey, 
