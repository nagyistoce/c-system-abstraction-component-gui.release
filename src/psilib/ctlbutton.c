...
//---------------------------------------------------------------------------
	...
	void DrawButtonCaption( PSI_CONTROL pc, PBUTTON pb, int xofs, int yofs, CDATA color, _32 *yout, _32 *maxwout, Font font )
{
	_32 y = 0;
	_32 w, h, maxw = 0;
...
CONTROL_PROPERTIES_APPLY( Button )( PSI_CONTROL pControl, PSI_CONTROL page )
{
	// read the dialog...
