...
%MAKE% __NO_SQL__=1 __NO_OPTIONS__=1 DEST=static_release DEST_PREFIX=no_opt_ -C src/intershell/widgets
%MAKE% __NO_SQL__=1 __NO_OPTIONS__=1 DEST=static_release DEST_PREFIX=no_opt_ -C src/intershell/widgets/banner/banner_cmd
%MAKE% __NO_SQL__=1 __NO_OPTIONS__=1 DEST=static_release DEST_PREFIX=no_opt_ -C src/utils/launcher
%MAKE% __NO_SQL__=1 __NO_OPTIONS__=1 DEST=static_release DEST_PREFIX=no_opt_ -C src/utils/top_picker
