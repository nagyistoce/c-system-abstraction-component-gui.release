...
#define SYSTEM_PROC(type,name) type CPROC name
#else
#define SYSTEM_PROC(type,name) extern type CPROC name
#endif
#endif
...
typedef void (CPROC*TaskOutput)(PTRSZVAL, PTASK_INFO task, CTEXTSTR buffer, _32 size );
