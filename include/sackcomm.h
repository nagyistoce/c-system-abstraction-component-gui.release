...
#define SACKCOMM_PROC(type,name) LITERAL_LIB_EXPORT_METHOD type CPROC name
#else
#define SACKCOMM_PROC(type,name) LITERAL_LIB_IMPORT_METHOD type CPROC name
#endif
...
#ifndef BCC16
SACKCOMM_PROC( int, ReadComm )( int nCommId, POINTER buffer, int nLen );
#endif
